...
def load_features(csv_path: str, gene_col: str, verbose: bool = True) -> pd.DataFrame:
...
def print_intersection_check(ppi_edgelists_all, features_df, pos_genes, neg_genes, verbose: bool = True):
...
def compute_global_nodes(ppi_edgelists_all, features_df, cache_path: str, use_cache: bool, verbose: bool = True):
